...
void TestWaylandSeat::testTouch()
{
    ...
    m_seatInterface->setTouchSurfacePosition(serverSurface, surfacePosition);
    QCOMPARE(m_seatInterface->touchSurfacePosition(serverSurface), {}); // Invalid because there is no surface yet
    m_seatInterface->setTimestamp(timestamp++);
